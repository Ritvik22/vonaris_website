    ...
    return (
        <section ref={containerRef} className="w-full bg-obsidian py-32 md:py-40 px-6 relative z-10 min-h-[80vh] flex items-center justify-center">
            <div className="max-w-6xl mx-auto">
                <p className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-light text-white text-center leading-relaxed tracking-tight flex flex-wrap justify-center gap-x-3 gap-y-2">
                    {words.map((word, i) => {
